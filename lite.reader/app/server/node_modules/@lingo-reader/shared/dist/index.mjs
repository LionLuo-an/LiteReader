import path$1, { resolve as resolve$1, basename as basename$1, extname as extname$1, dirname as dirname$1 } from 'node:path';
...
function isAbsolutePosix(p) {
  return path$1.posix.isAbsolute(p);
}
function joinPosix(...paths) {
  return path$1.posix.join(...paths);
}
var path = {
  resolve,
  basename,
